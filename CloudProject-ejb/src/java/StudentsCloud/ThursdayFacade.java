 ...
 */
@Stateless
public class ThursdayFacade extends AbstractFacade<Thursday> implements ThursdayFacadeLocal {
    ...
    public ThursdayFacade() {
        super(Thursday.class);
    }
    public List<String> searchMe(String id)
   {
       List<String> arr = new ArrayList<String>();
       Thursday mon = find(id);
       if(mon==null)
        return arr;
       else
       {
