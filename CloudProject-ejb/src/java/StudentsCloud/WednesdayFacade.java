 ...
 */
@Stateless
public class WednesdayFacade extends AbstractFacade<Wednesday> implements WednesdayFacadeLocal {
    ...
    public WednesdayFacade() {
        super(Wednesday.class);
    }
    public List<String> searchMe(String id)
   {
       List<String> arr = new ArrayList<String>();
       Wednesday mon = find(id);
       if(mon==null)
        return arr;
       else
       {
